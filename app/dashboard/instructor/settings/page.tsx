...
export default function InstructorSettings() {
  checkUserRole(["admin", "instructor"])
  ...
  const [studentMessageNotifications, setStudentMessageNotifications] = useState(true)
  const [clockInNotifications, setClockInNotifications] = useState(true)
  const [progressAlerts, setProgressAlerts] = useState(true)
  const [groupActivityNotifications, setGroupActivityNotifications] = useState(true)
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Manage your instructor account preferences</p>
            </div>
          </div>
        </div>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="profile" className="space-y-6">
            ...
            <SettingsCard
              ...
              description="Your instructor account details"
            ...
            >
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  ...
                  <Switch
                    checked={studentMessageNotifications}
                    onCheckedChange={setStudentMessageNotifications}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-1">
                      <p className="font-medium text-foreground">Clock In/Out Alerts</p>
                      <p className="text-sm text-muted-foreground">Notifications for clock in/out reminders</p>
                    </div>
                  </div>
                  <Switch
                    checked={clockInNotifications}
                    onCheckedChange={setClockInNotifications}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">Updates about student group activities</p>
                    </div>
                  </div>
                  <Switch
                    checked={groupActivityNotifications}
                    onCheckedChange={setGroupActivityNotifications}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">Alerts when students fall behind</p>
                    </div>
                  </div>
                  <Switch
                    checked={progressAlerts}
                    onCheckedChange={setProgressAlerts}
                  />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">Instructor Access</p>
                      <p className="text-sm text-muted-foreground">Full instructor privileges enabled</p>
                    </div>
                  </div>
                  <Badge className="bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20">
                    Active
