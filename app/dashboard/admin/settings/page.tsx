      ...
      <div className="space-y-8 p-6 md:p-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground">Admin Settings</h1>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          <TabsList className="bg-secondary/50 p-1 rounded-xl flex-wrap">
            ...
            <TabsTrigger value="system" className="rounded-lg data-[state=active]:bg-card data-[state=active]:shadow-sm">
            ...
            >
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={userData?.school_id || "System Admin"}
                    disabled
                    className="rounded-xl bg-secondary/50 border-border/50"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    value={userData?.name || "Administrator"}
                    disabled
                    className="rounded-xl bg-secondary/50 border-border/50"
                  />
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">Alerts for unusual user activity</p>
                    </div>
                  </div>
                  <Switch
                    checked={userActivityNotifications}
                    onCheckedChange={setUserActivityNotifications}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">Important system status notifications</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-1">
                      <p className="font-medium text-foreground">Resource Uploads</p>
                      <p className="text-sm text-muted-foreground">Notifications for new resource uploads</p>
                    </div>
                  </div>
                  <Switch
                    checked={resourceUploadNotifications}
                    onCheckedChange={setResourceUploadNotifications}
                  />
                </div>
          ...
          <TabsContent value="security" className="space-y-6">
            ...
            <SettingsCard
              ...
              description="Your account security information"
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Full system access enabled</p>
                    </div>
                  </div>
                  <Badge className="bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/20">
                    Active
